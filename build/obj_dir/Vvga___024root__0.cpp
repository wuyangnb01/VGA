...
void Vvga___024root___nba_sequent__TOP__0(Vvga___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*0:0*/ __Vdly__vga__DOT__clkgen_inst__DOT__count;
    __Vdly__vga__DOT__clkgen_inst__DOT__count = 0;
    // Body
    __Vdly__vga__DOT__clkgen_inst__DOT__count = vlSelfRef.vga__DOT__clkgen_inst__DOT__count;
    __Vdly__vga__DOT__clkgen_inst__DOT__count = (1U 
                                                 & ((IData)(1U) 
                                                    + (IData)(vlSelfRef.vga__DOT__clkgen_inst__DOT__count)));
    if (vlSelfRef.vga__DOT__clkgen_inst__DOT__count) {
        vlSelfRef.vga__DOT__pclk = (1U & (~ (IData)(vlSelfRef.vga__DOT__pclk)));
        __Vdly__vga__DOT__clkgen_inst__DOT__count = 0U;
    }
    vlSelfRef.vga__DOT__clkgen_inst__DOT__count = __Vdly__vga__DOT__clkgen_inst__DOT__count;
}
...
void Vvga___024root___nba_sequent__TOP__1(Vvga___024root* vlSelf) {
    ...
    __Vdly__vga__DOT__vga_ctrl_inst__DOT__x_cnt = (0x000003ffU 
                                                   & ((IData)(1U) 
...
void Vvga___024root___eval_nba(Vvga___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*0:0*/ __Vinline__nba_sequent__TOP__0___Vdly__vga__DOT__clkgen_inst__DOT__count;
    __Vinline__nba_sequent__TOP__0___Vdly__vga__DOT__clkgen_inst__DOT__count = 0;
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered[0U])) {
        __Vinline__nba_sequent__TOP__0___Vdly__vga__DOT__clkgen_inst__DOT__count 
            = vlSelfRef.vga__DOT__clkgen_inst__DOT__count;
        __Vinline__nba_sequent__TOP__0___Vdly__vga__DOT__clkgen_inst__DOT__count 
            = (1U & ((IData)(1U) + (IData)(vlSelfRef.vga__DOT__clkgen_inst__DOT__count)));
        if (vlSelfRef.vga__DOT__clkgen_inst__DOT__count) {
            vlSelfRef.vga__DOT__pclk = (1U & (~ (IData)(vlSelfRef.vga__DOT__pclk)));
            __Vinline__nba_sequent__TOP__0___Vdly__vga__DOT__clkgen_inst__DOT__count = 0U;
        }
        vlSelfRef.vga__DOT__clkgen_inst__DOT__count 
            = __Vinline__nba_sequent__TOP__0___Vdly__vga__DOT__clkgen_inst__DOT__count;
    }
